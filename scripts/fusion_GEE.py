...
import os
os.environ.update({
    'HTTP_PROXY': 'http://Username:Password@192.168.0.9:8080',  #MODIFY ACCORDING TO YOUR PROXY USERNAME, PASSWORD AND IP ADDRESS
    'HTTPS_PROXY': 'http://Username:Password@192.168.0.9:8080'  #MODIFY ACCORDING TO YOUR PROXY USERNAME, PASSWORD AND IP ADDRESS 
})

# ee.Authenticate()
ee.Initialize(project='ee-nirajgeewrk') #MODIFY ACCORDING TO YOUR PROJECT NAME
...
def main():
    ...
    AOI_PATH = r"D:\GEE\SAR-NDVI\src\SAR-OPT_fusion_GEE-main\AOI\grid_201.shp"     #MODIFY PATH ACCORDING TO YOUR SHAPEFILE LOCATION
    ...
    ====================================
    """
    parent_folder = "projects/ee-nirajgeewrk/assets/Folder1"  #MODIFY ACCORDING TO YOUR EARTH ENGINE ASSET PATH
